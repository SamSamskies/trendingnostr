...
import { hasDisplayableNoteContent, trimNoteContentForCache } from "./noteContent.js";
...
async function toServerTrendingFeed(notes, engagementById, hours) {
  ...
  const [engagement, reportSpamIds, llmSpamIds, vertexProfilePubkeys] =
    await Promise.all([
  ...
  const ranked = rankTrendingNotes(visible, engagement, {
